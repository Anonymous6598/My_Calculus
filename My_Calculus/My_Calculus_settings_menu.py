import customtkinter, tkinter.messagebox, pickle, My_Calculus, typing, My_Calculus_settings_window_interface
...
class Settings_window(customtkinter.CTkToplevel, My_Calculus_settings_window_interface.My_Calculus_settings_window_interface):
    ...
    def __change_button_color__(self, pickle_serialization: pickle) -> None:
        ...
        if language_data == "Српски":
            tkinter.messageboxshowwarning(title="Пажња", message="Рестартуј програм")

        elif language_data == "English":
            tkinter.messageboxshowwarning(title="Warning", message="Restart program")

        else:
            tkinter.messageboxshowwarning(title="Внимание", message="Перезагрузите программу")        
