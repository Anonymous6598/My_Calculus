...
import customtkinter, tkinter, pickle, unicodedata, sys, numpy, matplotlib, matplotlib.pyplot, typing, My_Calculus_interface, locale, re, warnings, My_Calculus_AI_window_interface, My_Calculus_AI, speech_recognition
...
class My_Calculus_AI_window(customtkinter.CTkToplevel, My_Calculus_AI_window_interface.My_Calculus_AI_window_interface):
	...
	def __response_from_ai__(self: typing.Self, configure: str | None = None) -> None:
		...
		self.query: str = My_Calculus_AI.My_Calculus_LM().__response__(pipe=SLM, prompt=self.ai_window_entry_data)
